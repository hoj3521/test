...
<style>
   ...
   tbody>tr{display:table; width:900px;}
   tbody>tr>td:nth-child(1) {
      width:16%; vertical-align:middle;
    }
   tbody>tr>td:nth-child(2){ width:100%; }
            ...
            <table border="2">
               ...
               <tbody class="tbody">
                  ...
                  <tr> 
                     ...
                     <td><input type="password" name="mem_passwd" id="pwd1"
                           maxlength="8" required
                           placeholder="8자 이상의 영문과 숫자 특수문자 포함"/>
                  </td></tr>
                  
                  <tr><td>비밀번호 확인<span class="red">*</span></td>
                     <td><input type="password" name="mem_repasswd" id="pwd2"
                           maxlength="8" required
                           onchange="pwdCheck();"/>&nbsp;<b><span id="same" style="font-size:14px;"></span></b>
                  </td></tr>
                  ...
                  <tr>
                     ...
                     <td>
                        ...
                        <input type="text" name="mem_email_address" id="email_add"/>
                  ...
                  <tr> 
                     ...
                     <td>
                     <!-- [중요] script 태그는 body 태그에 주는 것이 퍼포먼스가 좋다. -->
                     <script>
                     /* [문제해결 시나리오 작성] 가입가능한 나이 설정 : 현재 기준 만 14세부터~만 80세까지 설정
                        1. 시스템의 날짜를 얻어온다.
                        2. 시스템의 날짜에서 '년도'만 가져온다 => 2023년도
                        3. 설정년도의 시작 년도 2023-15=2008
                        4. 설정년도의 마지막 년도 2023-80=1943 
                     */
                  
                     let today = new Date();
                     let toyear = parseInt(today.getFullYear());  //2023년을 가져옴
                     let start = toyear - 15;
                     let end = toyear - 80;
                     ...
                     <td>
                        <div class="inputArea">
                           ...
                           <p>
                              ...
                              placeholder="주소"/>
                              <br/>
                              <input type="text" name="useraddr3" id="extraAddress" size="48" 
                              placeholder="참고항목(도로명인 경우: 지역 동이름과 아파트 이름)"/>
                              
                              <input type="text" name="useraddr2" id="detailAddress" size="45" 
